...
@Component(
{
  template:
    `<form [coolProcedure]="procedure" [coolWindow]="window">
      <div coolType coolClose="MyWindow">area</div>
    </form>`,
  providers:
  [
    {
...
class TestComponent
{
  ...
  directive: CloseEventDirective;
}

describe("CloseEventDirective", () =>
{
  it("should trigger open event", async () =>
  {
    ...
    const debugElement = fixture.debugElement.
      query(By.directive(CloseEventDirective));
    ...
    await expect(component.params.type).toBe("Close");
